...
typedef struct {
	...
	threadTest.stack_size = stackSize; 		//Not dynamic needs to be the size of the allocation passe din
  ...
  for (i = 0; i < num_threads; i++)
     {
         ...
         //assembly calls
         newThread = mythread_create(i, 800);
     }
...
mythread_scheduler(void *context  //current sp){
